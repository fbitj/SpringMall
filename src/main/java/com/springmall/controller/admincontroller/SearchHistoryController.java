...
public class SearchHistoryController {
    ...
    @ResponseBody
    public BaseRespVo<Map<String,Object>> getSearchHistory(Integer page,Integer limit,String sort,String order,Integer userId,String keyword){
        BaseRespVo<Map<String, Object>> re = new BaseRespVo<>();
